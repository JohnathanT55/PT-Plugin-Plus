 ...
 *  Vuetify 的其他样式会被自动构造在 /pt-plugin-plus-mv3.css 中
 */
...
export function mountApp(document: Document, data: any = {}) {
  ...
  // 将构造过程中产生的样式 pt-plugin-plus-mv3.css 添加到 shadow DOM 中
  ...
  buildStyleElement.href = chrome.runtime.getURL("pt-plugin-plus-mv3.css");
